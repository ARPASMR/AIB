...
(
  ...
  cum_rain real NOT NULL DEFAULT 0.0, -- cumulative rain from <<date>>CUMplzln_g.dat
  rain real NOT NULL DEFAULT 0.0, -- cumulative rain from raincum_tmp_<<date>>.txt
  snow real NOT NULL DEFAULT 0.0, -- snow
...
COMMENT ON COLUMN meteo_input.rain IS 'rain';
COMMENT ON COLUMN meteo_input.snow IS 'snow';
