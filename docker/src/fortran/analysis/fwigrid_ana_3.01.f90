...
!  17/06/20		RG/LP versione 3.0: modificata la 2.1 per essere compilata con Gfortran e non con Intel Compiler: corretti errori di sintassi (uso $ nei nomi, internal write, ecc..)
...
!  Precipitazioni totali
    ...
    DO ir=1,iRIGok
      WRITE(125,"((1x,f7.1))") (rvPIOG24_ANA_GRID(ic,(iRIGok+1-ir)), ic=1,iCOLok)
    END DO
    CLOSE(125)
